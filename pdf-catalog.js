...
function toggleFullscreen(modal) {
 ...
 // Add text layer for text selection - REMOVED for stability
async function addTextLayer(page, viewport, canvas, modal) {
  // Text selection removed for stability - only search functionality remains
  console.log('ℹ️ Text selection disabled for stability - search functionality only');
}
